...
Introduction
This is a breif project created by using HTML to demostrate the foundational skills associated with basic HTML.
The aim of this project is to create a recipies website using only HTML. There will be no CSS or Javascript.
